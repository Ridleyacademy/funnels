...
(function () {
  ...
  safe(function () {
    ...
    function saveLead() {
      try {
        localStorage.setItem(STORE_KEY, JSON.stringify({
          ...
          q1: answers.q1, q2: answers.q2, consent: !!(consent && consent.checked)
        }));
      } catch (e) {}
    }
    ...
    form.addEventListener('submit', function (e) {
      ...
      unlockCalendar({ name: nv, email: ev, phone: pv, q1: answers.q1, q2: answers.q2 });
  ...
  if (v) {
    ...
    var poll = setInterval(function () {
      try {
        ...
        var mk = (d && isFinite(d) && d < GATE_AT) ? Math.max(1, d * 0.85) : GATE_AT;
        if (t >= mk) { clearInterval(poll); gateOpen(); }
      } catch (e) {}
    }, 1000);
  } else { gateOpen(); }
